<template>
  <div class="table-demo">
    ...
    <div class="demo-section">
      <h3>带复选框和序号</h3>
      <iip-table :data="tableData" :columns="basicColumns" show-checkbox show-seq border
    ...
    <div class="demo-section">
      <h3>带分页</h3>
      <iip-table :data="paginatedData" :columns="basicColumns" :pagination="paginationConfig" border
...
import type { TableColumn } from '@bingwu/iip-ui-components/dist/components'
