  ...
  <div id="app">
    <div class="dev-container">
      ...
      <div class="demo-section">
        ...
        <div class="demo-item">
          <h3>基础表格</h3>
          <iip-table ref="tableRef" :data="tableData" :columns="basicColumns" border stripe
            :pagination="paginationConfig" @checkbox-all="selectAllChangeEvent" @checkbox-change="selectChangeEvent"
            ...
            :edit-config="{ trigger: 'click', mode: 'cell' }" :column-config="{ resizable: true }"
